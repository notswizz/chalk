...
export default function HomePage() {
  ...
  // Pick the featured game: highest-scoring live game, or next upcoming
  const featuredGame = liveGames.length > 0
    ? [...liveGames].sort((a, b) =>
        (Number(b.homeTeam.score) + Number(b.awayTeam.score)) -
        (Number(a.homeTeam.score) + Number(a.awayTeam.score))
      )[0]
    : null;

  const remainingLive = featuredGame
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 pt-6 pb-6">
      ...
      {!loading && games.length > 0 && (
        <div className="chalk-ticker fade-up fade-up-delay-1 mb-6">
      ...
      {/* ─── Chalk Tray ─── */}
      {!loading && games.length > 0 && (
        <div className="chalk-tray fade-up mt-8">
      ...
      <div className="hero-card rounded-[4px] overflow-hidden relative">
        ...
        <div className="flex items-center justify-center gap-4 px-5 py-5 relative z-10">
          ...
          <div className="flex-1 flex flex-col items-center gap-2.5">
            <TeamLogo logo={game.awayTeam.logo} name={game.awayTeam.displayName} size={52} glow />
            <div className="text-center">
              <div className="text-sm chalk-header" style={{ color: awayLeading ? 'var(--chalk-white)' : 'var(--chalk-dim)' }}>
          ...
          {/* Home */}
          <div className="flex-1 flex flex-col items-center gap-2.5">
            <TeamLogo logo={game.homeTeam.logo} name={game.homeTeam.displayName} size={52} glow />
            <div className="text-center">
              <div className="text-sm chalk-header" style={{ color: homeLeading ? 'var(--chalk-white)' : 'var(--chalk-dim)' }}>
